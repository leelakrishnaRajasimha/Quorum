...
class RiskAgent:
    ...
    def analyze(self, idea: StartupIdea, board_context: str) -> AgentResponse:
        ...
        prompt = f"""
You are the Chief Risk Officer (CRO) of Quorum.
...
Read the entire executive discussion.

Do NOT repeat Research, Finance, Product, Architecture or Marketing.

Identify risks based on everything discussed.
...
"""
        ...
        if response.startswith("ERROR"):
            ...
            return AgentResponse(
                ...
                finding="Risk analysis could not be completed.",
